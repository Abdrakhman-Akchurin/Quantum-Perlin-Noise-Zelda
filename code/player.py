...
class Player(Entity):
	...
	def restrict_movement(self):
		# Calculate the map boundaries in pixels
		map_width = MAP_SIZE[0] * TILESIZE  # MAP_SIZE[0] is the number of tiles horizontally
		map_height = MAP_SIZE[1] * TILESIZE # MAP_SIZE[1] is the number of tiles vertically

		# Ensure the player's hitbox stays within these boundaries
		...
		# Update the player's rect to match the hitbox position
